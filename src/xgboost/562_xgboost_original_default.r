...
ksemilla_azar  <- 664967  #Aqui poner la propia semilla
...
setwd("~/MEDGC/13_LaboratorioImplementacion/labo/exp/HT5620/")   #Establezco el Working Directory DEL EXPERIMENTO
