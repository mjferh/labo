...
Estrategia_A  <- function(q, tiros1, tiros2)
{
  #Estrategia
  ...
  umbral  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1, prob=q) ]
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 > umbral, id ]
  ...
  planilla_cazatalentos[ ids_juegan2,  aciertos_totales := aciertos1 + aciertos2 ]
...
for( experimento  in  1:10000 )
{
  ...
  veredicto  <- Estrategia_A(0.5, 70, 250)
