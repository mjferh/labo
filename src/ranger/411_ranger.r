...
param  <- list( "num.trees"=       1948,  #cantidad de arboles
                "mtry"=             14,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  456,  #tamaño minimo de las hojas
                "max.depth"=        7   # 0 significa profundidad infinita
              )

set.seed(777137) #Establezco la semilla aleatoria
