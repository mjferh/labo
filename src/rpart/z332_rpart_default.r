...
ksemilla_azar  <- 777137   #cambiar por la primer semilla
...
setwd("~/MEDGC/13_LaboratorioImplementacion/labo/exp/HT3320/")   #Establezco el Working Directory DEL EXPERIMENTO
